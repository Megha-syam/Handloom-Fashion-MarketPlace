        ...
        <div class="header-content">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="adminlogin" id="logoutBtn"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="dashboard-grid">
            <div class="dashboard-card">
                ...
                <div class="btn-group">
                    ...
                    <button class="btn btn-primary" onclick="showModal('addnewartisan')">
            ...
            <div class="dashboard-card">
                ...
                <div class="btn-group">
                    <button class="btn btn-primary" onclick="showModal('productsModal')">
                        <i class="fas fa-list"></i> View Products
                    </button>
                    <button class="btn btn-secondary" onclick="showAddProductForm()">
